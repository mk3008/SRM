...
internal static class UnitTestInitializer
{
	...
	public static void CreateTableAndData(IDbConnection cn)
	{
		...
		// create system transaction table.
		...
		// create application transaction table and data.
		cn.Execute("""
